...
|----------------------------------------------------------------|---------------|-----------|-------------|------|-----------|---------------------|---------------------------------------------------------------------|
| **2.0 (_planned_, _unreleased_)**                              | Dev           | 2.2 → 3.2 | 10.0 → 10.1 | 21+  | 7.2 → 8.0 | 5.0+ (Jakarta EE 9) | ❌ Servlet < 5.0 containers will not work                            |
| **1.3 (master, _unreleased_)**                                 | Dev           | 2.2 → 3.2 | 10.0 → 10.1 | 21+  | 7.2 → 8.0 | 4.0 (Java EE 8)     | ✅ _Unofficial_: Servlet 2.5 → 3.1 & Rails 6.1 → 7.1 also likely OK. |
