...
|----------------------------------------------------------------|---------------|-----------|------------|------|-----------|---------------------|----------------------------------------------------------------|
| **2.0 (_planned_, _unreleased_)**                              | Dev           | 2.2 → 3.2 | 9.4 → 10.1 | 8+   | 7.0 → 8.1 | 5.0+ (Jakarta EE 9) | ❌ Servlet < 5.0 containers will not work                       |
| **1.3 (master, _unreleased_)**                                 | Dev           | 2.2 → 3.2 | 9.4 → 10.1 | 8+   | 7.0 → 8.1 | 4.0 (Java EE 8)     | ✅ _Unofficial_: Servlet 2.5 → 3.1 & Rails 6.1 likely working   |
