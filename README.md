...
|----------------------------------------------------------------|---------------|-----------|-------------|------|-----------|--------------------------------------|-----------------------------------------------------------|
| **2.0** (_master_)                                             | Maintained    | 2.2 → 3.2 | 10.0 → 10.1 | 21+  | 7.2 → 8.1 | 5.0 → 6.1 (Jakarta EE 9 → 11)        | ❌ Servlet < 5.0 containers will not work                 |
...
| [**1.2**](https://github.com/jruby/jruby-rack/tree/1.2-stable) | EOL @ 2026-09 | 2.2       | 9.3  → 10.1 | 8+   | 5.0 → 8.1 | 3.0 → 4.0 (Java    EE 6 → 8)         |                                                           |
| [**1.1**](https://github.com/jruby/jruby-rack/tree/1.1-stable) | EOL @ 2024-05 | 1.x → 2.2 | 1.6  → 9.4  | 6+   | 2.1 → 5.2 | 2.5 → 4.0 (Java    EE 5 → 8)         |                                                           |
