...
describe JRuby::Rack::Queues::MessageSender do
  it "should delegate #send_message to JRuby::Rack::Queues.send_message" do
    JRuby::Rack::Queues.should_receive(:send_message).with("FooQ", "hello")
    obj = Object.new
  ...
  it "should allow setting up a default queue name with MessageSender::To()" do
    JRuby::Rack::Queues.should_receive(:send_message).with("FooQ", "hello").ordered
    JRuby::Rack::Queues.should_receive(:send_message).with("BarQ", "hello").ordered
    obj = Object.new
  ...
  it "should allow omitting the message argument and specifying a block" do
    ...
    JRuby::Rack::Queues.should_receive(:send_message).with("FooQ").ordered.and_yield message
    JRuby::Rack::Queues.should_receive(:send_message).with("BarQ").ordered.and_yield message
    obj = Object.new
    obj.extend JRuby::Rack::Queues::MessageSender::To("FooQ")
