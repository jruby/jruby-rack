Rails40::Application.configure do
  ...
  # config.threadsafe! is deprecated. 
  # Rails applications behave by default as thread safe in production as long 
  # as config.cache_classes and config.eager_load are set to true.
